...
const navItems = [
  ...
  { to: '/teacher/queries', icon: MessageCircleQuestion, label: 'Student Queries', badge: 0 },
...
const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  '/teacher/doubts': { title: 'Doubts (Legacy)', subtitle: 'Legacy doubts system' },
  '/teacher/queries': { title: 'Student Queries', subtitle: 'Review and respond to student questions' },
