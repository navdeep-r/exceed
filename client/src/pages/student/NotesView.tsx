...
export default function NotesView() {
  ...
  return (
    <>
      {/* Voice Mode overlay — passes note content as context */}
      {showVoiceMode && (
        <VoiceMode
      ...
      <div className="flex flex-col min-h-screen bg-surface-950 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  title="Ask the AI tutor about this note using your voice"
                >
        ...
        <div className="flex-1 p-8">
          <div className="max-w-5xl mx-auto">
            {activeTab === 'notes' && (
              <>
                {/* Voice Mode inline prompt strip */}
                <div
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-surface-500">Talk to your AI tutor and get spoken explanations for anything in these notes</p>
                    </div>
                  </div>
