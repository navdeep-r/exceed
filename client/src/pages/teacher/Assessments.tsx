        ...
        {mockQuizzes.map((quiz, i) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[13px] font-medium text-gray-200 group-hover:text-white transition-colors">{quiz.title}</p>
              <div className="flex items-center gap-3 mt-1">
                <span className="text-[11px] text-gray-500">{quiz.questions} questions</span>
                <span className="text-[11px] text-gray-500">{quiz.attempts} attempts</span>
                {quiz.avgScore > 0 && <span className="text-[11px] text-gray-500">Avg: {quiz.avgScore}%</span>}
              </div>
            </div>
